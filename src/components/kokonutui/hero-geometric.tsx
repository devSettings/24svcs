...
export default function HeroGeometric({
  ...
  return (
    <div className="relative flex h-screen w-full items-center justify-center overflow-hidden bg-[#030303]">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            <p className="mx-auto mb-8 max-w-xl px-4 text-base font-light leading-relaxed tracking-wide text-white/40 sm:text-lg md:text-xl">
              Building the future of digital interactions with creativity and
